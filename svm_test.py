...
precision = precision_score(truth_num, predict_num, average=None)
f1 = f1_score(truth_num, predict_num, average=None)
recall = recall_score(truth_num, predict_num, average=None)
# 打印混淆矩阵
